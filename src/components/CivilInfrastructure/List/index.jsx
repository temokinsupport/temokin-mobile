    ...
    <section className="--container-4" data-scroll-section>
      <Container>
        <Row className="justify-content-center">
          <Col md={8}>
            <div>
              <Row className="item" style={{'margin-bottom' : '10vw', 'position' : 'relative'}}>
                <Image
                  style={{'position': 'absolute', 'bottom': '-13%', 'right': '-43%', 'width': '75%'}}
                  src={
                    require("../../../assets/images/civilinfrastructure/350.svg")
                      .default
                  }
                />
                <Col md={12} style={{'margin-top': '25vw', 'font-size': '13px', 'font-weight': '700', 'letter-spacing': '2px'}}>
                  {" "}
                  PIPE JACKING WORK{" "}
                </Col>
                <Row>
                  <Col md={4}>
                    <Col style={{'font-size': '12px', 'font-weight': '700', 'margin-top': '3vw'}}>
                      Client
                    </Col>

                    <Col style={{'font-size': '11px', 'margin-top': '3vw'}}>
              ...
              <Row className="item" style={{'margin-bottom' : '10vw'}}>
                <Col md={12} style={{'margin-top': '5vw', 'font-size': '13px', 'font-weight': '700', 'letter-spacing': '2px' , 'line-height': '2'}}>
                  {" "}
              ...
              <Row className="item" style={{'margin-bottom' : '10vw', 'position' : 'relative'}}>
                <Image
                  style={{'position': 'absolute', 'bottom': '-20%', 'right': '-65%', 'width': '100vw'}}
                  src={
              ...
              <Row className="item" style={{'margin-bottom' : '10vw', 'position' : 'relative'}}>
                <Image
                  style={{'position': 'absolute', 'bottom': '-40%', 'right': '-65%', 'width': '100vw'}}
                  src={
                    require("../../../assets/images/civilinfrastructure/460.svg")
                      .default
                  }
              ...
              <Row className="item" style={{'margin-bottom' : '10vw', 'position' : 'relative'}}>
                <Image
                  style={{'position': 'absolute', 'bottom': '-10%', 'right': '-43%', 'width': '75%'}}
                  src={
                    require("../../../assets/images/civilinfrastructure/350.svg")
                      .default
                  }
